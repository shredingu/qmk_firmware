...
void render_kb_CAPS_WORD_text(void) {
...
void render_layer_state(void) {
    ...
    } else if (layer_state_is(U_EXTRA)) {
        oled_write_P(PSTR("Extra"), false);
    } else if (layer_state_is(U_TAP)) {
        oled_write_P(PSTR("Tap  "), false);
    } else if (layer_state_is(U_BUTTON)) {
        oled_write_P(PSTR("Butn "), false);
